...
| T-038 | Сравнение форвардеров UA↔EU: цена, фотофиксация, сроки (учесть сбор 3 €/подпозиция) | TODO | — |
| T-040 | 🔴 Мониторинг законопроекта №15460 (НДС на посылки в UA) — проверять ежеквартально | TODO | — |
| T-041 | Пересчитать экономику EU-forward после отмены de minimis | DONE | arena-agent-sandbox-20260817-1152 |
| T-042 | Отслеживать customs handling fee ЕС (~€2/посылка, возможно с 11.2026) | TODO | — |
| T-043 | Product Identifiers обязательны с 01.11.2026 — оценить влияние | TODO | — |
