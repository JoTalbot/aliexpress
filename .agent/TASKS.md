...
| T-046 | Изменения политики возвратов AliExpress | при аномалиях · **прогон 2026-08-17**: US-программа упрощения возвратов, следить за распространением на EU/UA | `research/09`, `research/12` |
